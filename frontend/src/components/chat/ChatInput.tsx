  ...
  return (
    <div className="w-full">
      <form
        ...
        className="puq-glass group relative flex items-center overflow-hidden rounded-[2rem] border border-slate-200/80 bg-white/70 shadow-[0_8px_30px_rgba(15,23,42,0.04)] transition-all duration-500 focus-within:border-slate-400 focus-within:bg-white focus-within:shadow-[0_12px_40px_rgba(15,23,42,0.08)]"
      >
        {contextPill ? (
          <div className="ml-3 flex shrink-0 items-center gap-2 rounded-2xl bg-teal-50 border border-teal-100 py-2 pl-3 pr-2 text-[11px] font-bold text-teal-800 backdrop-blur-md transition-all animate-in fade-in zoom-in duration-300 max-w-[40%] sm:max-w-[50%]">
        ...
        <button
          ...
          className="absolute right-2.5 top-1/2 flex h-11 w-11 -translate-y-1/2 cursor-pointer items-center justify-center rounded-2xl bg-slate-900 text-white shadow-md shadow-slate-900/10 transition-all hover:bg-slate-800 active:scale-90 disabled:cursor-not-allowed disabled:bg-slate-100 disabled:text-slate-400 disabled:shadow-none"
        >
          {isSubmitting ? (
